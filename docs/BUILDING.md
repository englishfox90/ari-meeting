# Building Ari Meeting from Source

This guide provides detailed instructions for building Ari Meeting from source on different operating systems. Clone the public fork from `https://github.com/henryvn27/meetily_improved.git`; the supported application is the Tauri desktop app under `frontend/`.
