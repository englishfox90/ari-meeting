...
pub fn get_available_models() -> Vec<ModelDef> {
    vec![
        ...
        // Gemma 4 E4B - Latest-generation Gemma, balanced tier.
        ModelDef {
            ...
            description: "Latest Gemma 4 (E4B) balanced model. Great quality/speed trade-off. Requires ~6GB RAM.".to_string(),
        },
        // Gemma 4 E2B - Latest-generation Gemma, fast/compact tier.
        ModelDef {
            ...
            layer_count: 30,
            sampling: SamplingParams::gemma3_instruct(vec!["<end_of_turn>".to_string()]),
            description: "Latest Gemma 4 (E2B) compact model. Fast, low-footprint local summaries.".to_string(),
        },
    ]
}
