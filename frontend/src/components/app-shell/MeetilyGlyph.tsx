...
export function MeetilyGlyph({ name, ...props }: MeetilyGlyphProps) {
  ...
  return (
    <svg viewBox="0 0 20 20" aria-hidden="true" focusable="false" {...props}>
      {name === 'ai' && <><path {...shared} d="M8.4 5.2 9.9 9.4 14.1 10.9 9.9 12.4 8.4 16.6 6.9 12.4 2.7 10.9 6.9 9.4Z" /><path {...shared} d="M14.3 3.3 14.9 5.1 16.7 5.7 14.9 6.3 14.3 8.1 13.7 6.3 11.9 5.7 13.7 5.1Z" /></>}
      ...
      {name === 'calendar' && <><rect {...shared} x="3.6" y="4.4" width="12.8" height="11.8" rx="1.9" /><path {...shared} d="M3.6 7.7h12.8M6.6 2.9v2.8m6.8-2.8v2.8" /></>}
      ...
      {name === 'people' && <><circle {...shared} cx="7.6" cy="6.6" r="2.4" /><path {...shared} d="M3.2 16.2a4.4 4.4 0 0 1 8.8 0" /><path {...shared} d="M13.1 4.6a2.4 2.4 0 0 1 0 4.6M15.4 16.2a4.4 4.4 0 0 0-2.9-5.6" /></>}
      ...
      {name === 'series' && <><rect {...shared} x="7.4" y="7.4" width="8.4" height="8.4" rx="1.8" /><path {...shared} d="M12.6 7.4V6.2a1.8 1.8 0 0 0-1.8-1.8H6.2a1.8 1.8 0 0 0-1.8 1.8v4.6a1.8 1.8 0 0 0 1.8 1.8h1.2" /></>}
