...
export function PreferenceSettings() {
  ...
  const handleMenuBarChange = async (enabled: boolean) => {
    ...
    try {
      ...
      setMenuBarError('Ari Meeting could not update the menu bar icon. Try again.');
    }
  };
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between gap-6">
          <div>
            ...
            <p id="menu-bar-description" className="mt-1 text-sm text-muted-foreground">
              Keep Ari Meeting available beside your Mac status icons. Ari Meeting remains in the Dock when this is off.
            </p>
          </div>
          <Switch
            aria-label="Show Ari Meeting in menu bar"
      ...
      <section className="settings-card">
        ...
        <p className="mb-6 mt-1 text-sm text-muted-foreground">
          View and access where Ari Meeting stores your data
        </p>
