...
export class RecordingService {
  ...
  async startRecordingWithDevices(
    ...
    // camelCase keys — Tauri v2 maps them onto the snake_case Rust params.
    // (Passing snake_case here silently dropped the device names to None,
    // so device selection was ignored and recording used the defaults.)
