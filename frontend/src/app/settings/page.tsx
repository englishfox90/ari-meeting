...
import { MeetingSearchSettings } from '@/components/MeetingSearchSettings';
import { AppearanceSettings } from '@/components/AppearanceSettings';
import { NotchSettings } from '@/components/NotchSettings';
import { AppleModelStatus } from '@/components/AppleModelStatus';
...
const TABS = [
  ...
  { value: 'calendar', label: 'Calendar', glyph: 'calendar' }
  ...
  return (
    <div className="app-page">
      <PageHeader
        ...
        title="Settings"
        description="Manage recording, transcription, summaries, and storage."
      />
      {loadError && (
        <AppState
          compact
      ...
      <div className="mt-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="summaryModels">
              ...
              <MeetingSearchSettings />
            </TabsContent>
            <TabsContent value="calendar">
              <h2 className="sr-only">Calendar settings</h2>
              <CalendarSettings />
            </TabsContent>
          </Tabs>
      </div>
