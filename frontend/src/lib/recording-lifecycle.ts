...
export function getPostRecordingPresentation(
  ...
  if (status === 'stopping') {
    return {
      ...
      description: statusMessage || 'Ari Meeting is closing the local audio pipeline before it finishes the transcript.',
      nativeProgress,
  ...
  if (status === 'processing') {
    return {
      ...
      description: statusMessage || 'Ari Meeting is draining the remaining local transcription work.',
      nativeProgress,
  ...
  if (status === 'saving') {
    return {
      ...
      description: statusMessage || 'Ari Meeting is writing the completed meeting and transcript to the local database.',
      nativeProgress: null,
  ...
  return {
    ...
    description: statusMessage || 'Ari Meeting could not finish the local meeting save.',
    nativeProgress: null,
