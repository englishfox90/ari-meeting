...
//!
//! Tauri-free: the `#[tauri::command]` shim (`claude_cli_detect`) stays in the
//! host (`frontend/src-tauri/src/summary/claude_cli.rs`); this module holds the
//! pure logic per the ari-engine carve's per-service migration recipe
