...
//!
//! Tauri-free: the `#[tauri::command]` shim (`api_suggest_template`) stays in
//! the host (`frontend/src-tauri/src/summary/template_selector.rs`); this
//! module holds the pure logic plus `api_suggest_template_impl`, per the
...
pub async fn api_suggest_template_impl(
    engine: &Engine,
    text: String,
    speaker_count: Option<u32>,
